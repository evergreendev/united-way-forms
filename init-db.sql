...
(
    ...
    `Check/Cash_Amount`             varchar(255) null,
    Check_Number                   varchar(255) null,
    Check_Date                     varchar(255) null,
    Billing_Period                 varchar(255) null,
    Billing_Amount                 varchar(255) null,
    Automatic_Bank_Withdrawl_Amount varchar(255) null,
    credit_card_given              varchar(255) null,
    Credit_Card_Amount             varchar(255) null,
    List_Name_In_Leadership_Directory varchar(255) null,
    Leadership_Directory_Name      varchar(255) null,
